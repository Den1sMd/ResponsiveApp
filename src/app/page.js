  ...
  const handleSubmit = (e) => {
    ...
    const handleLogin = async () => {
      const res = await fetch("http://localhost:5000/register", {
        ...
        body: JSON.stringify({ username, twitter, password, parrainage })
      })
    ...
    <div className="bg-white w-full min-h-screen flex justify-center items-center flex-col overflow-hidden">
      <div className="border-1  w-[350] flex rounded-2xl flex-col border shadow-2xl mt-15">
        <div className=" bg-blue-500 h-20 w-full flex justify-center rounded-t-2xl">
          <div className="flex justify-center items-center">
            <p className="text-white text-2xl font-bold">Inscription</p>
          </div>
        </div>
        ...
        <div className="flex flex-col items-center mt-4">
          ...
          <label className="text-gray-700  font-bold">Twitter</label>
          ...
          <label className="text-gray-700  font-bold">Parrainage</label>
          ...
          <div className="bg-red-800 w-70 mt-2 rounded-md justify-center items-center flex">
            <p className="text-white font-bold text-md">{error}</p>
          </div>
      ...
      <a href="/login">
        ...
        <div className="flex flex-row items-center justify-center gap-3">
          ...
          <p className="text-lg">Déja un compte ?</p>
        </div>
      </button>
      </a>
      </div>
